    ...
    if(fp)
            ...
            case 1:///INGRESO COMO DOCENTE
                {
                    ...
                    for(i ; i<3 ; i++)
                    {
                        ...
                        if(d==1234)
                        {
                            ...
                            case 3:
                                {
                                    printf("Elija una comision:\n");
                                    mostrarComisiones(comisiones,validos);
                                    scanf("%d",&comision);
                                    posCom = buscarPosComision(comisiones,comision,validos);
                                    printf("Ingrese el legajo del alumno que quiere eliminar: ");
                                    scanf("%d",&legajo);
                                    eliminarAlumno(comisiones[posCom].listaMateria,legajo);
            ...
            case 2:///INGRESO COMO ALUMNO
                ...
                if(fp)
                {
                    while (f==1)
                    {
                    mostrarAlfa(comisiones,validos);
                    ...
                    if(existeLegajo(comisiones[posCom].listaMateria->arbolNota,legajo))
                    {
                        mostrarListaMateria(comisiones[posCom].listaMateria);
                        printf("\nIngrese el id de la materia para ver sus notas \n");
                        scanf("%i",&idMateria);
...
void mostrarAlfa()
{
   stAlumno alumnado[15];
    ...
    if(fp!=NULL)
    {
        while (fwrite(&nuevo,sizeof(stRegistro),1,fp)==1)
        {
            alumnado[i].nombreAlumno=
